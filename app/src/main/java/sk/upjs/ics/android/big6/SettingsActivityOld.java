    ...
    private void deleteAllHistory() {
        ...
        AsyncQueryHandler deleteHandler = new AsyncQueryHandler(getContentResolver()) {
            ...
            protected void onDeleteComplete(int token, Object cookie, int result) {
                Toast.makeText(SettingsActivityOld.this, "Training history database was deleted", Toast.LENGTH_SHORT)
                        .show();
            }
        };
    ...
    private void deleteAllPhotos() {
        ...
        AsyncQueryHandler deleteHandler = new AsyncQueryHandler(getContentResolver()) {
            ...
            protected void onDeleteComplete(int token, Object cookie, int result) {
                ...
                Toast.makeText(SettingsActivityOld.this, "Photos was deleted!", Toast.LENGTH_SHORT)
                        .show();
            }
        };
